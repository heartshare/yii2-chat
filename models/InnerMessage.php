...
/**
 * This is the model class for table "inner_message".
 *
 * @property integer $id
 ...
 * @property InnerMessageAttachment[] $innerMessageAttachments
 */
class InnerMessage extends ActiveRecord implements StatusInterface
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getInnerMessageAttachments()
    {
        return $this->hasMany(InnerMessageAttachment::className(), ['message_id' => 'id']);
    }
