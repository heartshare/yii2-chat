...
class ChatController extends Controller{
    ...
    public function actionGetDialogs(){
        ...
        $dialogs = InnerMessageDialog::getUserDialogs($this->user->id);
    ...
    public function actionGetDialogMessages($dialogId){
        ...
        /**
         * @var $dialog InnerMessageDialog
         */
        $dialog = InnerMessageDialog::findOne(['id' => $dialogId]);
        ...
        if(!empty($json)){
            ...
            if($count){
                $json['count'] = $dialog->getInnerMessages()->count();
            }
        }
